...
class TranslateInstantDubBatchJob implements ShouldQueue
{
    ...
    private function buildTranslationMessages(array $batch, string $characterContext, string $fullDialogue): array
    {
        ...
        $systemPrompt = "You are an expert film/series dubbing translator who is fully fluent in both the source language and {$toLang}. Your task is to UNDERSTAND the original dialogue deeply — its meaning, subtext, humor, emotions, cultural references — and then EXPRESS that same meaning in natural spoken {$toLang} as if the film were originally made in {$toLang}.\n"
            ...
            . "   USE PUNCTUATION TO EXPRESS EMOTION (TTS reads these expressively):\n"
            . "   - Exclamation marks for anger/surprise/emphasis: \"Yo'q!\" \"Nima qilyapsan!\"\n"
            . "   - Ellipsis (...) for hesitation, trailing off, or thinking: \"Men... bilmayman\"\n"
            . "   - Question marks for rising intonation: \"Rostdanmi?\"\n"
            . "   - Dash (—) for dramatic pauses or interruptions: \"Men — senga aytdim\"\n"
            . "   - Short sentences with periods for stern/deliberate tone: \"Yo'q. Hech qachon.\"\n"
            . "   - Multiple !! for strong emotion: \"Ketdi!!\"\n"
