    ...
    private function buildTranslationMessages(array $batch, string $characterContext, string $fullDialogue): array
    {
        ...
        if ($this->language === 'uz') {
            ...
            $uzbekRules = "\n"
                ...
                . $fromLangHint . "\n"
                . "- SPELLING — preserve vowels in verb stems, do NOT drop them:\n"
                . '  * "taniyman" NOT "tanyman", "bileman" NOT "bilman", "ko\'raman" NOT "ko\'rman"' . "\n"
                . '  * "turaman" NOT "turman", "olaman" NOT "olman", "beraman" NOT "berman"' . "\n"
