        ...
        try {
            ...
            for ($i = 0; $i < $total; $i++) {
                ...
                $result = Process::timeout(20)->run([
                    ...
                    '-i', $originalAudioPath,
                    '-filter_complex',
                    "[0:a]aresample=44100,apad=whole_dur={$slotDuration}[tts];[1:a]equalizer=f=800:t=o:w=2.5:g=-18,equalizer=f=2500:t=o:w=1.5:g=-15,volume=0.15[bg];[tts][bg]amix=inputs=2:duration=first:normalize=0",
                    '-t', (string) $slotDuration,
